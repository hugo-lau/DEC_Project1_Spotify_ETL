...
class PostgreSqlClient:
    ...
    def __init__(
        ...
        self.connection_url = f"postgresql+pg8000://{username}:{password}@{server_name}:{port}/{database_name}"
        self.engine = create_engine(connection_url)

    def connect(self):
        # Establish a connection and store it
    ...
    def close(self):
        ...
        if hasattr(self, 'connection'):
            ...
            del self.connection  # Clean up the attribute
